...
const Contact = () => {
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: 'mailto:priyankgarg28@gmail.com',
      icon: (
    ...
    {
      name: 'Resume',
      url: '/Priyank_Garg_Resume_Sep24.pdf',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <p className="paragraph mb-6">
            I'm always open to discussing product management opportunities, sharing insights about Fintech, customer experience, and data platforms, or connecting with fellow product professionals.
